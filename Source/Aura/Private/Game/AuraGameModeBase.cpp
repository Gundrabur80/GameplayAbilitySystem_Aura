...
UAuraLoadScreenSaveGame* AAuraGameModeBase::RetrieveInGameSaveData() const
{
...
void AAuraGameModeBase::SaveIngameProgressData(UAuraLoadScreenSaveGame* SaveObject)
{
	UAuraGameInstance* AuraGameInstance = Cast<UAuraGameInstance> (GetGameInstance());
...
void AAuraGameModeBase::SaveWorldState(UWorld* World, const FString& DestinationMapAssetName) const
{
	...
	if (UAuraLoadScreenSaveGame* SaveGame = GetSaveSlotData(AuraGI->LoadSlotName, AuraGI->LoadSlotIndex))
	{
...
void AAuraGameModeBase::LoadWorldState(UWorld* World) const
{
	...
	{
		UAuraLoadScreenSaveGame* SaveGame = Cast<UAuraLoadScreenSaveGame>(UGameplayStatics::LoadGameFromSlot(AuraGI->LoadSlotName, AuraGI->LoadSlotIndex));
		if (SaveGame == nullptr)
		{
...
void AAuraGameModeBase::TravelToMap(UAuraMVVM_LoadSlot* Slot)
{
...
{
	UAuraLoadScreenSaveGame* SaveGame = RetrieveInGameSaveData();
